...
public class FutabaThreadRegexParser {  
  
    //本文パターンは全てこれで取れる
    //private static final textPattern = Pattern.compile('<blockquote>(.+?)</blockquote>');
    //画像パターン
    ...
    public FutabaThreadRegexParser(String urlStr) {  
        this.urlStr = urlStr;
        title="(title)";
    ...
    public void parse() {  
        ...
        try {  
            ...
            parser.setInput(new StringReader(new String(data, "Shift-JIS")));
